  ...
  return (
    <div className="flex overflow-hidden relative flex-col gap-4 justify-center items-center pt-10 w-full h-full short:lg:pt-10 pb-footer-safe-area 2xl:pt-footer-safe-area px-sides short:lg:gap-4 lg:gap-8">
      <motion.div layout="position" transition={{ duration: DURATION, ease: EASE_OUT }}>
        <h1 className="font-serif text-5xl italic short:lg:text-8xl sm:text-8xl lg:text-9xl text-foreground">Trackt</h1>
      </motion.div>
          ...
          {!isOpen && (
            ...
            >
              <div className="flex flex-col gap-4 w-full max-w-xl md:gap-6 lg:gap-8">
                ...
                >
                  Turn every run into conquest. Build your empire, claim your streets, dominate your neighborhood.
                </motion.p>
              </div>
            </motion.div>
          )}
          ...
          {isOpen && (
            ...
            >
              <article className="relative overflow-y-auto italic p-6 h-full [&_p]:my-4">
                <p>
                  Transform your daily runs into epic territory battles. Every step captures ground, every route expands your kingdom, every mile proves your dominance. Welcome to running's new battleground.
                </p>
              </article>
            </motion.div>
          )}
